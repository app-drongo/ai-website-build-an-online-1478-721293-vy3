...
import { ArrowRight, Sparkles, Heart, Award, Shield } from 'lucide-react';
...
export default function Cta() {
  const stats = [
    ...
    { value: 'Lifetime', label: 'Warranty', icon: Shield },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Each piece tells a story of passion, precision, and artistry. Join our community of
                jewelry lovers who choose authentic craftsmanship over mass production.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Featured in prestigious jewelry publications
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Complimentary Gift Wrapping</h3>
              <p className="text-sm text-muted-foreground">
                Beautiful presentation for every special moment
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Authenticity Guarantee</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Personalization Available</h3>
              <p className="text-sm text-muted-foreground">
                Custom engraving and bespoke design services
              </p>
            </div>
          </div>
        </div>
